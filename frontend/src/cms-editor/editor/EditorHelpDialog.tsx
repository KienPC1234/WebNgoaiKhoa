...
export const EditorHelpDialog: React.FC<EditorHelpDialogProps> = ({ open, onClose, anchorRef }) => {
  return (
    <Modal open={open} onClose={onClose} anchorRef={anchorRef} ariaLabel="Hướng dẫn sử dụng CMS Editor" maxWidth="max-w-5xl">
