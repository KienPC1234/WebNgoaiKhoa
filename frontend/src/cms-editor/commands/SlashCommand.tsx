...
export const SlashCommand: React.FC<SlashCommandProps> = ({ query, commands, onRun }) => {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-2 space-y-1" aria-label="Menu lệnh gạch chéo">
      ...
      {results.length === 0 && <p className="px-3 py-2 text-xs text-gray-400">Không có lệnh phù hợp</p>}
    </div>
  )
}
