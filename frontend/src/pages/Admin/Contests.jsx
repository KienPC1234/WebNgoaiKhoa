...
const emptyContest = {
  ...
  max_file_size_mb: 15, require_approval: true, show_author: true,
  show_vote_count: true, show_comments: true, min_title_length: 6,
  max_title_length: 200, min_content_length: 30, max_content_length: 60000,
                  ...
                  {subsLoading ? (
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                      {selectedContestSubs.submissions.map(sub => (
                        <div key={sub.id} className="flex items-center justify-between bg-white rounded-lg px-3 py-2 border">
                          <div className="min-w-0">
