...
export const GioiThieuDoiNgu = () => {
    const staff = [
        { name: "ThS. Nguyễn Văn A", role: "Trưởng bộ môn Ngữ Văn", image: "https://i.pravatar.cc/150?u=a", bio: "Hơn 15 năm kinh nghiệm giảng dạy và nghiên cứu văn học hiện đại." },
        { name: "TS. Trần Thị B", role: "Giảng viên Lịch sử", image: "https://i.pravatar.cc/150?u=b", bio: "Chuyên gia về lịch sử bang giao quốc tế và văn hóa Việt Nam." },
        { name: "ThS. Lê Văn C", role: "Huấn luyện viên Vovinam", image: "https://i.pravatar.cc/150?u=c", bio: "Võ sư trung đẳng, tâm huyết với sự nghiệp phát triển võ thuật học đường." },
        { name: "ThS. Phạm Thị D", role: "Giảng viên Địa lí", image: "https://i.pravatar.cc/150?u=d", bio: "Nghiên cứu sâu về biến đổi khí hậu và quy hoạch vùng." },
    ]
        ...
        <div className="min-h-screen bg-gray-50/50 pb-20">
            ...
            <section className="bg-gradient-to-br from-[#1a2d6c] via-[#283593] to-blue-900 text-white py-24 px-4 relative overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto relative z-10 text-center space-y-8">
                    ...
                    >
                        ĐỘI NGŨ <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-200 not-italic">GIÁO VIÊN TÂM HUYẾT</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        ...
                        >
                            <Card className="p-0 border-none bg-white shadow-xl rounded-[40px] overflow-hidden group hover:-translate-y-4 transition-all duration-500">
                                ...
                                <div className="p-8 space-y-3">
                                    <h4 className="text-xl font-black text-gray-800 tracking-tight group-hover:text-fpt-blue transition-colors">{p.name}</h4>
                ...
                <section className="mt-24 bg-gradient-to-br from-fpt-blue to-[#0d1b4a] rounded-[50px] p-12 lg:p-20 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            <h2 className="text-4xl md:text-5xl font-black italic uppercase italic tracking-tighter leading-tight">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <Card className="aspect-square bg-white/5 border-white/10 flex flex-col items-center justify-center text-center p-6 space-y-4 hover:bg-white/10 transition-colors">
                                ...
                                <div className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-200">Nghiên cứu khoa học</div>
                            </Card>
                        </div>
                    </div>
                </section>
