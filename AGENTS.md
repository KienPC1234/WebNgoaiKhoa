...
- 2026-04-14: Completed frontend optimization phase 2 with route lazy-loading/code-splitting, shared RichTextEditor component rollout across admin long-form fields (Stories/Events/Nhân vật/Post Designer), and public HTML render compatibility updates for stories/events/publication detail pages.
- 2026-04-14: Completed public-page design consistency QA pass by normalizing HTML excerpt rendering on Home/Subject Hub/Honors and revalidated frontend production build.
...
- 2026-04-14: Completed CMS-editor text model refinement with markdown-rendered paragraph blocks, hidden markdown-redundant text blocks from insert library, and fixed document-title input flicker caused by repeated initial-document reload.
- 2026-04-14: Completed UI refinement follow-up: refreshed desktop nav dropdown appearance, removed hero campaign/brand duplicate labels, and increased headline line spacing for "Nhịp đập / Sáng tạo".
- 2026-04-14: Completed public subpage visual refresh: unified cleaner hero/panel styling across key public pages and switched Home hero to orange checkerboard background.
- 2026-04-14: Completed nav usability polish with horizontal overflow support (hidden scrollbar), pill-style desktop nav items, and solid white dropdown panel background.
- 2026-04-14: Completed UI cleanup pass by removing nav glass-blur layering and refreshing AI chat widget to a cleaner compact card style.
- 2026-04-14: Completed navbar spacing refinement by widening header paddings, adding direct quick links (Sự kiện/Truyền cảm hứng), and replacing stark white nav backgrounds with warm neutral tones.
- 2026-04-14: Completed nav and profile polish pass: removed remaining white-heavy navbar surfaces, added dropdown internal scrollbar for long menus, relaxed large-heading letter spacing, and widened/refined profile page layout.
- 2026-04-14: Completed nav interaction fix with click-toggle dropdown reliability (Giới thiệu/Chuyên môn/Nhân vật), restored subtle navbar blur backdrop, and refined Home hero "Editorial Insight" badge styling.
- 2026-04-14: Completed desktop nav overflow UX update by removing horizontal scroll, introducing a three-line "Thêm" overflow dropdown for extra links, and reducing Home hero "Editorial Insight" badge footprint.
- 2026-04-14: Started deep-dive diagnosis for `/admin/publications/:id/edit` CMS Editor document flicker/title switching between publication payload and document model snapshots.
- 2026-04-14: Completed CMS Editor flicker hotfix by removing parent-child document feedback loop in Post Designer, gating `onDocumentChange` to dirty edits, and stabilizing publication edit initialization flow.
- 2026-04-14: Completed nav rebuild with hover-only dropdowns (single `openMenu` state, outside-click dismiss), removed "Thêm" overflow button, and fixed all Vietnamese diacritics in admin pages (Events/Stories/NhanVat) + public pages (GioiThieuQuyMo/GioiThieuDoiNgu).
- 2026-04-14: Added centralized frontend `apiClient` + `cmsService`, refactored Admin CMS modules (Dashboard/Publications/Events/Stories/Nhân vật) to shared services, and validated frontend production build.
- 2026-04-14: Started auth UI Vietnamese-diacritics pass and login loading-state hotfix.
- 2026-04-14: Completed auth backend hotfix by cleaning duplicated `auth.py` content, restored OTP/recaptcha/unsubscribe flow integrity, and revalidated with backend tests + frontend build.
- 2026-04-14: Completed auth UI Vietnamese-diacritics pass, added reCAPTCHA timeout fail-safe in login/register/verify flows, fixed DB init migration indentation issue, and revalidated login API (HTTP 200) + frontend build.
...
- 2026-04-14: Started UI refinement follow-up: simplify nav dropdown styling and clean hero branding/spacing per latest visual feedback.
- 2026-04-14: Completed UI refinement follow-up: refreshed desktop nav dropdown appearance, removed hero campaign/brand duplicate labels, and increased headline line spacing for “Nhịp đập / Sáng tạo”.
- 2026-04-14: Completed public subpage visual refresh: unified cleaner hero/panel styling across key public pages and switched Home hero to orange checkerboard background.
- 2026-04-14: Completed nav usability polish with horizontal overflow support (hidden scrollbar), pill-style desktop nav items, and solid white dropdown panel background.
- 2026-04-14: Completed UI cleanup pass by removing nav glass-blur layering and refreshing AI chat widget to a cleaner compact card style.
